  ...
  const products = await Promise.all([
    prisma.product.create({
      data: {
        ...
        description:
          "High-performance single shaft shredder blades for industrial recycling applications. Our single shaft shredders are designed for processing various materials with exceptional efficiency.",
    ...
    prisma.product.create({
      data: {
        ...
        description:
          "Heavy-duty metal recycling blades engineered for extreme durability. Designed to process ferrous and non-ferrous metals with consistent performance.",
        category: "metal",
        image:
          "https://images.unsplash.com/photo-1565688534245-05d6b5be184a?w=800&q=80",
        specs: JSON.stringify({
    ...
    prisma.product.create({
      data: {
        ...
        description:
          "Specialized plastic recycling blades optimized for processing various plastic materials. Features precision cutting edges for clean, consistent shredding.",
        category: "plastic",
        image:

...
const dir =
  "node_modules/.pnpm/@prisma+client@6.19.2_prism_d43f3015e135736aa0f7bb1a98aa3981/node_modules/.prisma/client";
for (const f of ["default.js", "client.js", "index.js"]) {
  ...
  console.log(
    `${f} | followUp:${hasFollowUp} | notes:${hasNotes} | size:${c.length}`
  );
}

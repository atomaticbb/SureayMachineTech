...
export default function OEMConversionFunnel({
  className = "",
}: OEMConversionFunnelProps) {
  return (
    <section
      className={`relative py-12 bg-[#003366] overflow-hidden ${className}`}
    >
      {/* Blueprint SVG Grid */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8">
          ...
          <p className="text-blue-200 text-lg leading-relaxed">
            Can't find your exact dimensions? Submit your drawings or physical
            samples. Our metallurgy team will engineer the optimal blade for
            your application.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-4">
            ...
            <div className="relative z-10 flex flex-row md:flex-col items-start md:items-center gap-4 md:gap-3 md:text-center group">
              ...
              <div>
                ...
                <p className="text-sm text-blue-200 leading-relaxed">
                  Provide an OEM part number, CAD file (.DXF / .PDF), or
                  physical blade sample. We accept all standard formats.
                </p>
              </div>
            </div>
            ...
            <div className="relative z-10 flex flex-row md:flex-col items-start md:items-center gap-4 md:gap-3 md:text-center group">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-1">
                  Material &amp; HRC Matching
                </h3>
                <p className="text-sm text-blue-200 leading-relaxed">
                  Our engineers select the optimal steel grade (D2, SKD11,
                  Carbide) and specify the precise vacuum heat treatment cycle.
                </p>
              </div>
            </div>
            ...
            <div className="relative z-10 flex flex-row md:flex-col items-start md:items-center gap-4 md:gap-3 md:text-center group">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-1">
                  Precision Machining &amp; QC
                </h3>
                <p className="text-sm text-blue-200 leading-relaxed">
                  CNC grinding to tight tolerances, followed by rigorous
                  hardness testing and full dimensional inspection before
                  delivery.
                </p>
              </div>
            </div>

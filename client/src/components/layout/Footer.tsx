    ...
    <footer className="bg-[#0a1219] text-slate-400 pt-20 pb-12">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-8 md:gap-12 lg:gap-16 xl:gap-20 mb-12 lg:mb-16">
          ...
          <div>
            ...
            <p className="text-[15px] leading-relaxed mb-8 max-w-sm text-slate-400">
              OEM precision blades for plastics recycling, paper converting,
              and metal processing. Vacuum heat treatment · CMM inspection ·
          ...
          <div>
            ...
            <ul className="space-y-4 text-[15px]">
              ...
              <li>
                <Link href="/products/rotary-slitter-knives" className="hover:text-white transition-colors">
            ...
            <div className="mt-6 pt-4 border-t border-slate-800">
              <Link href="/products" className="text-[13px] font-black text-slate-300 uppercase tracking-widest hover:text-white transition-colors">
                View All Products
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6 text-[15px]">
              ...
              <div>
                ...
                <a href="tel:+8615655530829" className="text-slate-300 hover:text-white transition-colors font-semibold">
                  +86 156 5553 0829
                </a>
                <p className="text-[11px] text-slate-600 mt-1">Available 24/7</p>
              </div>
              ...
              <div>
                ...
                <a href="mailto:lynn@sureay.com" className="text-slate-300 hover:text-white transition-colors font-semibold">
                  lynn@sureay.com
                </a>
              </div>
        ...
        <div className="border-t border-slate-800 pt-7 flex flex-col sm:flex-row justify-between items-center gap-3 text-[11px] font-semibold uppercase tracking-widest text-slate-600">
          <p>© {new Date().getFullYear()} Sureay Machinery Technology Co., Ltd.</p>
          <div className="flex items-center gap-6">
            <span className="hidden sm:inline text-slate-700">ISO 9001:2015 · Est. 2008 · 50+ Countries</span>

/**
 * MobileContactBar — Category Hub pages (/categories/:slug), mobile (<md).
 * Bottom sticky bar: WhatsApp icon + "Get a Quote" button. Replaces the
 * sitewide GlobalMobileCTA on these pages (suppressed via a route check in
 * GlobalMobileCTA.tsx) so only one floating bar shows.
 */
...
export default function MobileContactBar({
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed inset-x-0 bottom-0 z-30 bg-white border-t border-slate-200 shadow-2xl">

  ...
  return (
    <section className="bg-white border-t border-slate-200">
      <div className="bg-white border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 pt-14 lg:pt-16 pb-8 lg:pb-10">
          ...
          <h2 className="font-black text-2xl md:text-3xl lg:text-[36px] text-[#001f4d] uppercase tracking-tight leading-[1.05] max-w-3xl">
            Why Buyers Trust Our Engineering Process
          </h2>
          <p className="text-slate-500 max-w-2xl text-sm md:text-base leading-relaxed mt-4">
            Before moving forward, most teams need three answers: can the blade fit correctly, can the tolerance be trusted, and is the material recommendation matched to the real operating condition.
          </p>
          <div className="w-14 h-[3px] bg-slate-300 mt-6" />
        </div>
      </div>

      <div className="max-w-7xl mx-auto px-6 sm:px-8 pb-14 lg:pb-16">
          ...
          {BLOCKS.map((block, index) => {
            ...
            return (
              <div
                key={block.title}
                className={[
                  "grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 px-0 py-10 lg:py-12",
                ].join(" ")}
              >
                <div
                  className={[
                ...
                >
                  <div className="relative h-[240px] md:h-[280px] lg:h-[300px] overflow-hidden border border-slate-200 bg-slate-50">
                    <img
                      src={block.imageSrc}
                      alt={block.imageAlt}
                      loading="lazy"
                ...
                >
                  ...
                  <h3 className="font-black text-2xl md:text-[30px] text-[#001f4d] uppercase tracking-tight leading-[1.08] mb-4 max-w-2xl">
                    {block.title}
                  </h3>

...
export default function IndustryBlueprintDashboard({
  narrative,
  specs,
}: Props) {
  const {
  ...
  const solutionParts = highlightToken
    ? solutionBody.split(highlightToken)
    : null;
          ...
          <div className="relative">
            ...
            <p className="text-slate-600 text-[15px] leading-relaxed max-w-[480px] tracking-[0.015em]">
              {solutionParts ? (
                <>
                  {solutionParts[0]}
                  <strong className="font-black text-[#003366]">
                    {highlightToken}
                  </strong>
                  {solutionParts[1]}
                </>

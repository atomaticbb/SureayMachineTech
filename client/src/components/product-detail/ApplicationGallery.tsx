    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-[#003366] font-bold text-3xl mb-4">
            Industry Applications
          </h2>
          <p className="text-slate-600 text-base max-w-2xl mx-auto">
            Our industrial machinery delivers exceptional results across diverse
            manufacturing and recycling applications, from metal processing to

      ...
      <main className="bg-[#0a0f1a] min-h-screen">
        ...
        <div className="max-w-3xl mx-auto px-6 sm:px-8 py-16">
          <Section id="acceptance" title="1. ACCEPTANCE OF TERMS" delay={0.1}>
            ...
            <p>
              These Terms apply to all visitors, prospective buyers, and anyone
              who submits an enquiry or interacts with the Website. Sureay
              Machinery Technology Co., Ltd. ("Sureay", "we", "us") reserves the
          ...
          >
            <p>
              ...
              Sureay reserves the right to modify specifications without prior
              notice.
            </p>
            <p>
              <span className="text-white font-semibold">Quotations:</span> Any
              quotation provided by Sureay — whether via the Website contact
              form, email, or other channel — is an invitation to treat, not a
              binding offer. A contract is formed only upon Sureay's written
              order confirmation and receipt of any agreed deposit.
            </p>
            <p>
              <span className="text-white font-semibold">Pricing:</span> All
              prices quoted are exclusive of applicable taxes, duties, and
              shipping costs unless stated otherwise in writing. Prices are
            ...
            <p>
              ...
              buyers remain the intellectual property of the buyer. Sureay will
              not share submitted designs with third parties without written
              consent.
            </p>
          </Section>
          ...
          >
            <p>
              ...
              software — is owned by or licensed to Sureay and is protected by
              applicable copyright and trademark laws.
            </p>
            <p>
              You may view and print content for personal, non-commercial
              reference purposes only. You must not reproduce, redistribute, or
              create derivative works from any Website content without Sureay's
          ...
          <Section id="disclaimers" title="5. DISCLAIMERS" delay={0.3}>
            <p>
              ...
              non-infringement. Sureay does not warrant that the Website will be
          ...
          >
            <p>
              To the fullest extent permitted by applicable law, Sureay shall
            ...
            <p>
              Sureay's total aggregate liability for any claim arising from use
              of the Website shall not exceed the amount paid by you to Sureay
              in the three months preceding the claim, or USD 100, whichever is
              greater.
            </p>
          </Section>
          ...
          >
            <p>
              ...
              LinkedIn, YouTube, and WhatsApp). These links are provided for
              convenience only. Sureay has no control over the content of those
          ...
          <Section id="governing-law" title="8. GOVERNING LAW" delay={0.45}>
            <p>
              ...
              laws of the People's Republic of China. Any disputes arising out
              of or in connection with these Terms shall be subject to the
              exclusive jurisdiction of the courts of Anhui Province, China.
            </p>
            <p>
              For buyers located in jurisdictions with mandatory consumer or
              commercial protection laws, nothing in these Terms limits any
            ...
            <div className="border border-slate-800 p-5 bg-[#0d1520] space-y-2">
              ...
              <p>
                ...
                <a
                  ...
                  onClick={() =>
                    gtagEvent("phone_click", { link_location: "terms" })
                  }
                  className="text-[#e8b84b] hover:text-white transition-colors"
                >
                  +86 180 0555 0657

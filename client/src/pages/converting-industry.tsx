...
const HERO_DATA: IndustryHeroData = {
  ...
  gallery: [
    { src: "/images/applications/converting-industry/converting-industry.webp",       alt: "Flexible converting and packaging industry overview"      },
    { src: "/images/applications/converting-industry/rotary-slitter-knives-02.webp",  alt: "Rotary slitter knives for flexible packaging"             },
    { src: "/images/applications/converting-industry/rotary-slitter-knives-08.webp",  alt: "Precision slitter knife for film converting"              },
    { src: "/images/applications/converting-industry/rotary-slitter-knives-09.webp",  alt: "Slitter knife array for packaging line"                   },
    { src: "/images/applications/converting-industry/nonwoven-slitter-knives.webp",   alt: "Nonwoven slitter knives for SMS fabric"                   },
    { src: "/images/applications/converting-industry/nonwoven-slitter-knives-01.webp",alt: "Nonwoven fabric slitter knife detail"                     },
    { src: "/images/applications/converting-industry/cnc-machine.webp",               alt: "CNC precision grinding for converting knives"             },
    { src: "/images/applications/converting-industry/material.webp",                  alt: "Premium steel material for converting blades"             },
  ],
};
...
const SPECS: IndustrySpec[] = [
  { label: "Thickness Tol.", mainValue: "±0.002",    unit: "mm",  subtext: "Across Full Diameter"   },
  { label: "T.I.R. Runout",  mainValue: "≤ 0.02",    unit: "mm",  subtext: "Per Knife, CMM Verified" },
  { label: "Surface Finish", mainValue: "Ra ≤ 0.4",  unit: "μm",  subtext: "Precision Ground"        },
  { label: "Line Speed",     mainValue: "600",        unit: "m/min", subtext: "Verified Performance"  },
];

// ─── Materials ─────────────────────────────────────────────────────────────────
const MATERIALS: IndustryMaterial[] = [
  { name: "BOPP / BOPET Film",           abrasion: "MODERATE", grade: "M2 HSS / ASP23 PM",       image: "/images/materials/BOPP-BOPET.webp"       },
  { name: "Label Stock / Release Liner", abrasion: "LOW",      grade: "D2 / M2 HSS with TiN",    image: "/images/materials/label-stock.webp"      },
  { name: "SMS Medical Nonwoven",        abrasion: "LOW",      grade: "M2 HSS (ESD Coated)",     image: "/images/materials/medical-nonwoven.webp" },
];
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: {
        ...
        image: "https://sureay.com/images/products/rotary-slitter-knives/rotary-slitter-knives-02.webp",
        description: "D2 and M2 HSS circular slitter knives with DLC anti-adhesion coating for pressure-sensitive tape, adhesive laminate, and label stock slitting.",
        brand: { "@type": "Brand", name: "Sureay Industrial Blades" },
        url: "https://sureay.com/products/rotary-slitter-knives",
      },
    },

...
Ideal for recycling facilities, paper processing plants, plastic extrusion lines, and food processing operations requiring consistent, high-quality cuts over extended service periods.`,
  ...
  {
    id: "rotary-cutter-blade",
    name: "Rotary Cutter Blades",
    nameEn: "Rotary Cutter Blades",
    nameCn: "回转切刀",
    slug: "rotary-cutter-blades",
    shortDescription: "Precision-ground rotary cutter blades for clean, continuous slitting operations",
    description: "Our rotary cutter blades are engineered for high-speed, continuous cutting applications across the plastics, packaging, paper, and converting industries. Manufactured from premium grades of High-Speed Steel (HSS), D2 tool steel, and Tungsten Carbide, these circular knives offer exceptional wear resistance and razor-sharp edge retention. Advanced CNC grinding ensures strict concentricity and micro-level dimensional tolerances, preventing material tearing and extending blade changeover intervals during high-volume production.",
    mainCategory: "blades",
    ...
    specs: {
      material: "HSS (M2/SKH-51), D2 (SKD-11), Tungsten Carbide (YG8/YG15)",
      hardness: "HRC 60-64 / HRA 88-90 (carbide)",
      dimensions: "OD: 20mm to 1,200mm (customizable)",
      thickness: "0.5mm to 50mm",
      tolerance: "±0.002mm (thickness), ±0.01mm (concentricity)",
      coating: "Optional: TiN, TiCN, Teflon",
    },
    features: [
      "Ultra-precision CNC grinding to ±0.002mm thickness tolerance",
      "Zero runout guaranteed for vibration-free high-speed rotation",
      "Deep cryogenic treatment (−196°C) for maximum wear resistance",
      "Custom single bevel, double bevel, or toothed edge profiles",
      "Dynamic balancing on every blade before shipment",
      "Compatible with Kampf, Atlas, Dusenbery, Goebel, Tidland",
      "Solid tungsten carbide option for abrasive materials",
      "Mirror-polished surface (Ra 0.4) for reduced friction",
    ],
    applications: [
      "Plastic film slitting (BOPP, PET, PVC)",
      "Paper converting and cardboard slitting",
      "Rubber processing and tire cutting",
      "Textile and non-woven fabric slitting",
      "Foil and laminate processing",
      "Food packaging film cutting",
    ],
    compatibleBrands: [
      "Kampf, Atlas, Dusenbery, Goebel, Tidland",
      "100% custom-produced per drawings or physical samples",
    ],
    isFeatured: true,
    sortOrder: 2,
    seoTitle: "Rotary Cutter Blades Manufacturer | Precision Slitter Knives - Sureay",
    seoDescription: "High-precision rotary cutter blades in HSS, D2, and tungsten carbide. ±0.002mm tolerance, mirror polish, dynamic balanced. OEM compatible. Factory-direct pricing.",
    updatedAt: new Date(),
  },
  {

...
export type BladeSectorType = "recycling" | "paper" | "converting" | "metal" | "new_energy" | "other";
...
export const blades: Blade[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName:
      "Precision Rotary Slitter Knives & Anvils for Film, Paper & Foil Converting",
    ...
    specs: [
      { label: "Material", value: "52100 / D2 / M2 HSS / ASP23 PM / Solid Carbide" },
      {
        label: "Cutting Styles",
        value: "Shear Slitting, Score / Crush Cutting, Razor Slitting",
      },
      { label: "Outer Diameter", value: "50\u2013200\u202fmm (custom OD available)" },
      {
        label: "Tolerance",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "High-Speed Rotary Slitter Knives & Circular Cutting Blades for Paper, Tissue & Corrugated Converting",
    category: "slitter_knives",
    sector: "paper",
    categoryDisplay: "Rotary Slitter Knives",
    ...
    isFeatured: false,
    compatibleMachines: ["Atlas Converting", "Parkinson", "Kampf", "Laem System", "Euromac", "Goebel IMS", "Fabio Perini", "Körber"],

    specs: [
      { label: "Material", value: "D2 Tool Steel, M2 HSS, 52100 Bearing Steel" },
      { label: "Hardness", value: "HRC 58–64 (grade dependent)" },
      { label: "Cutting Styles", value: "Shear Slitting (matched pairs), Crush Cutting (anvil pairs)" },
    ...
    dimensionLabels: {
      ...
      col2: "Inner Diameter",
      col3: "Thickness",
      caption: "* Standard dimensions for paper converting. Top blades (dished profile for shear cutting) and bottom blades (grooved anvil for crush cutting). Custom OD/ID available for specific machine models.",
    },

    standardDimensions: [
      { spec: "Top Blade (Shear)", od: "75 mm", id: "45 mm", thickness: "1.0 / 1.2 mm" },
      { spec: "Bottom Anvil", od: "70 mm", id: "45 mm", thickness: "10 / 8 mm" },
      { spec: "Top Blade (Shear)", od: "100 mm", id: "32 mm", thickness: "1.2 mm" },
      { spec: "Bottom Anvil", od: "80 mm", id: "60 mm", thickness: "20 / 16 mm" },
      { spec: "Top Blade (Tissue)", od: "150 mm", id: "80 mm", thickness: "1.5 mm" },
      { spec: "Bottom Anvil", od: "108 mm", id: "80 mm", thickness: "20 / 18 mm" },
    ],

    relatedBladeIds: ["tissue-log-saw-blades", "paper-cutting-blades", "corrugated-slitter-scorer-blades"],
    offers: {
      lowPrice: 20,
      highPrice: 280,
    },
    faqs: {
      technical: [
        {
          question: "What material grade should I use for high-speed tissue converting at 500 m/min?",
          answer:
        ...
        {
          question: "How do I prevent fiber dust contamination at the slit edge?",
          answer:
        ...
        {
          question: "Should I use shear slitting or crush cutting for corrugated board converting?",
          answer:
        ...
        {
          question: "How often should paper slitter knives be reground, and how many regrinds are possible?",
          answer:
        ...
        {
          question: "What causes uneven slit edge quality across the full width of the paper web?",
          answer:
      ...
      company: [
        {
          question: "Can Sureay supply knives compatible with our existing Atlas Converting or Kampf slitter/rewinder?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    isFeatured: true,
    compatibleMachines: ["Kampf", "Sundwig", "GOEBEL IMS", "Fagor Arrasate", "Camu", "Heinrich Georg", "Kohler", "Yuri Roll", "Hohsen"],

    specs: [
      { label: "Material",       value: "ASP23, ASP52 (PM Steel), Solid Tungsten Carbide, D2/D3" },
      { label: "Hardness",       value: "HRC 64–67 (PM Steel) | HRA 91–92 (Carbide)" },
      { label: "Thickness Tol.", value: "Strictly ±0.001 mm" },
      { label: "Runout (T.I.R.)", value: "≤ 0.01 mm" },
      { label: "Surface Finish",  value: "Mirror-lapped Ra ≤0.02μm — prevents galling on Al/Cu" },
    ...
    dimensionLabels: {
      ...
      col2: "Inner Diameter",
      col3: "Thickness",
      caption: "* Dimensions represent common metal service center standards. We manufacture to exact machine specifications and can supply matching high-precision spacers ground to the same ±0.001mm tolerance.",
    },

    standardDimensions: [
      { spec: "Thin Foil Slitter",        od: "100 mm", id: "40 mm",  thickness: "1.0 / 1.5 mm"  },
      { spec: "Precision Strip Slitter",  od: "150 mm", id: "80 mm",  thickness: "2.0 / 3.0 mm"  },
      { spec: "General Strip Slitter",    od: "200 mm", id: "120 mm", thickness: "3.0 / 4.0 mm"  },
      { spec: "Silicon / Stainless Steel", od: "250 mm", id: "150 mm", thickness: "4.0 / 5.0 mm" },
      { spec: "Heavy Gauge Strip",        od: "300 mm", id: "200 mm", thickness: "5.0 / 10.0 mm" },
    ],
    ...
    faqs: {
      technical: [
        {
          question: "Should I use D2 or ASP23 for slitting stainless steel strips?",
          answer:
        ...
        {
          question: "How do you prevent 'galling' or metal build-up when slitting aluminum?",
          answer:
      ...
      company: [
        ...
        {
          question: "What is the lead time for PM steel or Carbide slitter knives?",
          answer:
...
// ─────────────────────────────────────────────────────────────────────────
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "Heavy-Duty D2/SKD11 Twin Shaft Claw Blades for Plastic, MSW & Wood Recycling",
    ...
    specs: [
      ...
      { label: "Bore Design",   value: "Precision Wire-EDM: Hex / Octagonal / Splined" },
      { label: "Compatibility", value: "Weima, Untha, SSI, Vecoplan, Genox" },
      { label: "Application",   value: "MSW · Plastics · Wood Pallets · Bulky Waste" },
    ],
    ...
    dimensionLabels: {
      ...
      caption: "* Standard series Φ150–Φ450 mm. Custom OD up to Φ800 mm, bore hex/octagonal/splined, and claw profiles available on request.",
    },

    standardDimensions: [
      { spec: "200 Series",  od: "Φ 150 mm", thickness: "15 mm", bore: "Hex Ø70 mm",      hooks: "5-Claw"  },
      { spec: "400 Series",  od: "Φ 180 mm", thickness: "20 mm", bore: "Hex Ø90 mm",      hooks: "8-Claw"  },
      { spec: "600 Series",  od: "Φ 200 mm", thickness: "20 mm", bore: "Hex Ø140 mm",     hooks: "8-Claw"  },
      { spec: "800 Series",  od: "Φ 250 mm", thickness: "25 mm", bore: "Hex Ø160 mm",     hooks: "8-Claw"  },
      { spec: "1000 Series", od: "Φ 300 mm", thickness: "30 mm", bore: "Hex Ø180 mm",     hooks: "12-Claw" },
      { spec: "1200 Series", od: "Φ 350 mm", thickness: "40 mm", bore: "Splined Ø200 mm", hooks: "12-Claw" },
      { spec: "1500 Series", od: "Φ 400 mm", thickness: "40 mm", bore: "Splined Ø220 mm", hooks: "3-Claw"  },
      { spec: "2000 Series", od: "Φ 450 mm", thickness: "30 mm", bore: "Splined Ø260 mm", hooks: "3-Claw"  },
    ],
    relatedBladeIds: ["tire-shredder-blades", "single-shaft-rotor-inserts", "granulator-blades"],
    offers: {
      lowPrice:  45,
      highPrice: 600,
    },
    faqs: {
      technical: [
        ...
        {
          question: "How do I choose between D2, SKD11, and 42CrMo for contaminated plastic or MSW shredding?",
          answer: "D2 (1.2379) is correct for post-consumer plastic bales with residual dirt and trace contamination. Upgrade to SKD11 when your feedstock includes glass-reinforced engineering plastics (PA66-GF30, ABS) mixed into contaminated streams. Select 42CrMo for timber or industrial scrap with high metal contamination risk—its higher impact energy absorption prevents brittle fracture on a metal strike."
        },
        {
          question: "How often should twin-shaft shredder blades be indexed or replaced on a continuous recycling line?",
          answer: "On a 16-hour continuous line processing post-consumer HDPE and PP, schedule first indexing at 400–600 operating hours with D2, and 600–800 hours with SKD11 on clean feedstock. Contaminated or glass-filled streams reduce these intervals by 30–40%. Fixed tonnage-milestone indexing is recommended rather than waiting for visible edge rounding."
        },
        {
          question: "Do you supply counter-knives and sizing screens as a complete tooling system?",
          answer: "Yes. We manufacture matched stationary counter-knives and perforated sizing screens as a complete twin-shaft shredding tooling system. Supplying rotor blades and counter-knives from the same grinding run ensures consistent shear clearance across the full rotor-to-bed interface."
        }
      ],
      company: [
        {
          question: "Are you a trading company or a direct manufacturer?",
          answer: "We are a 100% direct OEM manufacturer established in 2008. When you buy from Sureay, you bypass middleman markups and communicate directly with the engineers who forge and grind your blades."
        },
        {
          question: "What makes Sureay's heat treatment different from cheaper alternatives?",
          answer: "Unlike standard single-cycle quenching, every Sureay shredder blade undergoes vacuum hardening followed by 4–5 tempering cycles and deep cryogenic treatment at −196°C. This stabilizes the full martensite microstructure, boosting wear resistance by up to 40%."
        },
        {
          question: "Do you ship globally and how long does it take?",
          answer: "Yes, we export to over 50 countries. Standard OEM replacement blades typically ship within 48 hours. Custom profiles take 10–15 working days. We partner directly with DHL, FedEx, and international sea freight forwarders for reliable door-to-door delivery."
        },
        {
          question: "What quality certifications does Sureay hold?",
          answer: "Sureay is ISO 9001:2015 certified. Every shipment includes a Rockwell HRC hardness test report, a dimensional inspection record, and a heat treatment batch certificate. For OEM qualification, full CMM dimensional reports and steel mill certificates are available on request."
        },
        {
          question: "Can we trial a sample set before committing to a full production order?",
          answer: "Yes. We offer sample sets (typically 2–5 blades) for machine fit verification and edge life testing. Standard sample lead time is 5–7 working days."
        }
      ]
    }
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    isFeatured: true,
    compatibleMachines: ["Shred-Tech", "Arjes", "Forus", "SSI Shredding", "Bano", "Hammel"],

    specs: [
      { label: "Material",          value: "H13 (AISI H13 / 1.2344), 42CrMo (AISI 4140)" },
      { label: "Hardness",          value: "HRC 50–54 (Optimized for Shock Absorption)" },
      { label: "Claw Geometry",     value: "1, 2, or 3 Low-Profile Thick Hooks" },
      { label: "Thickness",         value: "40 mm – 150 mm (Heavy Duty)" },
      { label: "Bore Design",       value: "Heavy Splined / Multi-Keyway (Wire-EDM)" },
    ...
    dimensionLabels: {
      ...
      caption: "* Custom OD up to Ø800+ mm, specific spline profiles, and custom thicknesses available. Send us your rotor shaft drawing for an exact match.",
    },

    standardDimensions: [
      { spec: "E-Waste / Light Scrap",   od: "Φ 300–450 mm", thickness: "40–60 mm",  bore: "Hex / Light Splined", hooks: "3 Hooks"   },
      { spec: "Appliances / Steel Drums", od: "Φ 450–600 mm", thickness: "60–80 mm",  bore: "Medium Splined",      hooks: "2–3 Hooks" },
      { spec: "ELV / Heavy Demolition",  od: "Φ 600–800+ mm", thickness: "80–150 mm", bore: "Heavy Splined",       hooks: "1–2 Hooks" },
    ],
    ...
    faqs: {
      technical: [
        {
          question: "Why choose H13 or 42CrMo over D2 for metal shredding applications?",
          answer:
        ...
        {
          question: "What hook count and profile should I specify for ELV automotive shredding?",
          answer:
        ...
        {
          question: "How do splined bores prevent rotor shaft damage in heavy metal shredding?",
          answer:
        ...
        {
          question: "What are the warning signs that metal shredder blades need replacement?",
          answer:
      ...
      company: [
        {
          question: "Can you supply blades for Shred-Tech, Arjes, or Forus shredding platforms?",
          answer:
        ...
        {
          question: "What is the lead time for heavy-duty metal shredder blades?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "Precision Twin Shaft Shredder Blades for Li-Ion Battery Recycling",
    category: "shredder_blades",
    sector: "new_energy",
    categoryDisplay: "Shredder Blades",
    ...
    specs: [
      ...
      { label: "Application", value: "EV Battery Packs · Pouch Cells · 18650/21700" },
    ...
    dimensionLabels: {
      ...
      caption: "* Exact bore profiles, OD, and thickness supplied to customer drawings. Inert-gas compatible material options available.",
    },

    standardDimensions: [
      { spec: "Cylindrical / Pouch Cells", od: "Φ 200–350 mm", thickness: "10–20 mm", bore: "Hex / Splined", hooks: "±0.02 mm" },
      { spec: "EV Module / Battery Pack",  od: "Φ 400–600 mm", thickness: "30–50 mm", bore: "Splined",       hooks: "±0.05 mm" },
    ],

    relatedBladeIds: ["twin-shaft-blades-recycling", "single-shaft-rotor-inserts"],
    offers: {
      lowPrice:  300,
      highPrice: 3000,
    },
    faqs: {
      technical: [
        {
          question: "Why is ±0.02mm thickness tolerance critical for battery pack pre-shredding?",
          answer:
        ...
        {
          question: "What causes blade corrosion in lithium-ion battery shredding environments?",
          answer:
        ...
        {
          question: "Should twin-shaft or single-shaft shredders be used for Li-ion battery pre-processing?",
          answer:
        ...
        {
          question: "What bore profiles are required for nitrogen-purged battery shredder platforms?",
          answer:
      ...
      company: [
        {
          question: "Can you supply matched rotor and counter-knife sets for battery pre-shredders?",
          answer:
        ...
        {
          question: "What quality documentation is provided for battery recycling plant qualification?",
          answer:
        ...
        {
          question: "Do you offer sample blades for process validation before full production orders?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Eliminate crushed cores and excessive paper dust with our premium circular log saw blades for tissue, kitchen towel, and JRT converting lines. Engineered from vacuum-hardened D2 (1.2379) and Cr12MoV tool steel (HRC 58–60), these blades are micro-ground to a strict ≤0.15 mm lateral runout for flawless cross-cutting. The metallurgy is specifically optimized for continuous in-line CBN sharpening without glazing your grinding wheels. Exact OEM drop-in fit for Fabio Perini, PCMC, Casmatic, Gambini, and Bretting. Custom diameters from Ø610 mm to Ø1000 mm manufactured in just 10 working days.",
    ...
    specs: [
      ...
      { label: "Surface Finish", value: "Mirror Polished (Ra\u202f\u22640.2\u202f\u03bcm)" },
    ...
    faqs: {
      technical: [
        ...
        {
          question:
            "What is the longest blade diameter you can manufacture?",
          answer:
      ...
      company: [
        ...
        {
          question:
            "What quality certifications does Sureay hold?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    specs: [
      { label: "Material",      value: "18% Tungsten HSS Inlay | Tungsten Carbide Tipped (TCT)" },
      { label: "Hardness",      value: "HRC\u202f62\u201364 (HSS) | HRA\u202f89\u201391 (Carbide)" },
      { label: "Bevel Angle",   value: "Standard 21\u00b0\u202f\u2013\u202f24\u00b0 (Double bevel available)" },
      { label: "Face Flatness", value: "\u22640.05\u202fmm (Eliminates paper draw & tapered cuts)" },
      { label: "Construction",  value: "Bimetallic (premium edge brazed to alloy steel body)" },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    specs: [
      ...
      { label: "Target Hardness",     value: "HRC 58–62 (Cryogenically Stabilized)" },
      ...
      { label: "OEM Fitment",         value: "Vecoplan, Weima, Lindner, Zerma, Cresswood" },
      { label: "System Integration",  value: "Matched Bed Knives available separately" },
    ...
    dimensionLabels: {
      ...
      caption: "* Stator bed knives and custom rotor blade profiles available. Compatible with major global single-shaft shredder brands.",
    },

    standardDimensions: [
      { spec: "34 × 34 × 23 mm",   bolt: "M12",       type: "Concave / Flat",  oem: "Weima / Vecoplan Standard" },
      { spec: "40 × 40 × 25 mm",   bolt: "M14",       type: "Concave / Flat",  oem: "Vecoplan / Heavy Plastics" },
      { spec: "43 × 43 × 19.5 mm", bolt: "M14",       type: "Crown / Concave", oem: "Lindner Micromat / Urraco" },
      { spec: "50 × 50 × 30 mm",   bolt: "M16",       type: "Concave / Flat",  oem: "Heavy Duty MSW"            },
      { spec: "60 × 60 × 30 mm",   bolt: "M16 / M18", type: "Flat / V-Groove", oem: "Zerma / Tyre Shredding"    },
      { spec: "80 × 80 × 45 mm",   bolt: "M24",       type: "Concave",         oem: "Extreme High-Torque"       },
    ],

    relatedBladeIds: ["twin-shaft-blades-recycling", "granulator-blades", "single-shaft-bed-knives"],
    offers: {
      lowPrice:  20,
      highPrice: 200,
    },
    faqs: {
      technical: [
        {
          question: "Which alloy offers better edge retention for cutting rigid purges: D2 or DC53?",
          answer:
        ...
        {
          question: "How does the four-edge indexable design reduce tooling costs?",
          answer:
        ...
        {
          question: "What insert geometry is required for shredding large-format IBC totes and HDPE drums?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    dimensionLabels: {
      ...
      caption: "* Bed knives are highly machine-specific. Standard reference sizes shown in mm — we manufacture to exact OEM drawings or custom customer specs. Single-piece seamless up to 3,500 mm.",
    },
    ...
    faqs: {
      technical: [
        {
          question: "Why is the straightness tolerance of a bed knife so important?",
          answer:
        ...
        {
          question: "How do I ensure the replacement bed knife aligns with my machine's adjustment pushers?",
          answer:
        ...
        {
          question: "Should I replace the bed knife when I replace the rotor inserts?",
          answer:
      ...
      company: [
        {
          question: "Do you have the manufacturing capacity for blades over 2 meters long?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    relatedBladeIds: ["single-shaft-rotor-inserts", "twin-shaft-blades-recycling"],
    offers: {
      lowPrice: 25,
      highPrice: 320,
    },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    isFeatured: true,
    compatibleMachines: ["Fagor Arrasate", "Heinrich Georg", "Red Bud Industries", "Braner", "Salico", "Athader"],

    specs: [
      { label: "Material",          value: "D2, SKD11, Cr12MoV (Cold-Roll) | H13, 6CrW2Si (Hot-Roll)" },
      { label: "Hardness",          value: "HRC 60–62 (Cold-Roll) | HRC 54–58 (Hot-Roll / Impact)" },
      { label: "Thickness Tol.",    value: "Strictly ±0.001 mm" },
      { label: "Parallelism",       value: "≤ 0.002 mm" },
      { label: "Surface Finish",    value: "Mirror Lapped (Ra ≤ 0.2 μm)" },
      { label: "Complete Tooling",  value: "Knives, Spacers, Rubber Stripper Rings, Separators" },
    ...
    dimensionLabels: {
      ...
      col2: "Inner Diameter",
      col3: "Thickness",
      caption: "* Dimensions shown are standard examples. We manufacture up to Ø 1500 mm for heavy-gauge plate slitting lines. Custom keyways and drive pin holes machined to exact OEM blueprints.",
    },

    standardDimensions: [
      { spec: "Light Gauge Slitting Line",     od: "Ø 200 mm", id: "120 mm", thickness: "10 / 12 mm"  },
      { spec: "Standard Steel Service Center", od: "Ø 250 mm", id: "150 mm", thickness: "12 / 15 mm"  },
      { spec: "Medium-Heavy CR/HR Line",       od: "Ø 315 mm", id: "200 mm", thickness: "15 / 20 mm"  },
      { spec: "Heavy Gauge HR Steel Mill",     od: "Ø 400 mm", id: "260 mm", thickness: "20 / 25 mm"  },
      { spec: "Extreme Heavy Plate Mill",      od: "Ø 500 mm", id: "320 mm", thickness: "30 / 40 mm"  },
    ],

    relatedBladeIds: ["metal-foil-strip-slitter-knives", "scrap-chopper-blades"],
    offers: {
      lowPrice:  80,
      highPrice: 1500,
    },
    faqs: {
      technical: [
        {
          question: "What knife clearance should I set for cold-rolled steel versus silicon steel?",
          answer:
        ...
        {
          question: "Should I use D2 or H13 for slitting 8mm thick Hot-Rolled (HR) steel plate?",
          answer:
        ...
        {
          question: "What maintenance inspection schedule maximizes circular slitter knife service life?",
          answer:
      ...
      company: [
        ...
        {
          question: "Do you manufacture large diameter slitter knives for heavy plate mills?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "Heavy-Duty Guillotine & Scrap Shear Knives for Metal Fabrication",
    category: "metal_processing",
    sector: "metal",
    ...
    specs: [
      { label: "Material",           value: "D2 (Cr12MoV), S1 (6CrW2Si), H13, High Carbon Steel" },
      { label: "Cold / Mild Steel",  value: "High Carbon Tool Steel (HRC 57–59)" },
      { label: "Stainless / Heavy",  value: "D2 / Cr12MoV (HRC 58–60)" },
      { label: "Scrap / High Impact",value: "S1 / 6CrW2Si / H13 (Shock Resistant)" },
      { label: "Length Capacity",    value: "Up to 6000 mm (Single Piece Seamless)" },
    ...
    standardDimensions: [
      ...
      { spec: "Heavy Scrap Shear",      od: "Custom", id: "Custom", thickness: "Up to 100+" },
    ],
    ...
    faqs: {
      technical: [
        {
          question: "Which alloy should I use for shearing 304 stainless steel?",
          answer:
        ...
        {
          question: "Our blades keep chipping when cutting mixed scrap metal. What is wrong?",
          answer:
        ...
        {
          question: "How do double-edge reversible blades reduce my annual tooling cost?",
          answer:
      ...
      company: [
        ...
        {
          question: "Can Sureay manufacture replacement blades for obsolete heavy scrap shears?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faqs: {
      technical: [
        ...
        {
          question:
            "Can Tungsten Carbide (TC) trimmer blades be resharpened?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "Tungsten Carbide Circular Slitting Knives for Lithium Battery Electrode Foil",
    ...
    isFeatured: true,
    compatibleMachines: ["Kaido", "Koem", "Hirano Tecseed", "CKD", "Manz", "Targray"],

    specs: [
      { label: "Material",       value: "Ultra-fine WC-Co Tungsten Carbide, Cermet (on request)" },
      { label: "Surface Finish", value: "Mirror polish Ra ≤ 0.05μm — zero-notch edge" },
      { label: "Tolerance",      value: "Thickness: ±0.001mm | T.I.R. Runout: ≤0.01mm" },
      { label: "Hardness",       value: "HRA 91–93 (WC-Co grade)" },
      { label: "Coatings",       value: "DLC, TiN (optional, anti-adhesion for PVDF-coated foil)" },
    ...
    dimensionLabels: {
      ...
      col3: "Thickness",
      caption: "* Standard dimensions for battery electrode foil slitting. Custom OD/ID and thickness available for all winding machine models. Matched top/bottom pairs supplied with pre-verified clearance data sheet.",
    },
    ...
    faqs: {
      technical: [
        {
          question: "What surface finish standard is required to prevent micro-burrs on battery electrode foil?",
          answer:
        ...
        {
          question: "How do I set the knife-to-knife clearance for ultra-thin copper anode foil?",
          answer:
        ...
        {
          question: "What carbide grade should I specify for aluminum cathode foil vs. copper anode foil?",
          answer:
        ...
        {
          question: "What is the typical regrinding cycle on battery slitting knives?",
          answer:
      ...
      company: [
        {
          question: "Can Sureay supply battery slitting knives certified to IATF 16949 requirements?",
          answer:
        ...
        {
          question: "What is the lead time for standard and custom battery slitting knife orders?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "Tungsten Carbide Thin Slitter Blades for Corrugator Dry-End Lines",
    category: "slitter_knives",
    sector: "paper",
    ...
    isFeatured: true,
    compatibleMachines: ["BHS", "FOSBER", "Marquip", "Agnati", "Martin / Bobst", "TCY", "Isowa"],

    specs: [
      { label: "Main Product",       value: "Solid Tungsten Carbide Thin Slitter Blades (HIP Sintered)" },
      { label: "Material",           value: "Tungsten Carbide WC-Co K05 / K10 / K20 (grade by board type)" },
      { label: "Blade Hardness",     value: "HRA 90–92 (Optimized for wear and in-line grindability)" },
      { label: "Body Thickness",     value: "1.0 mm – 1.2 mm (Ensures high-speed rigidity)" },
      { label: "Edge Geometry",      value: "Precision lapped razor profile, ~0.3 mm apex (Zero-crush)" },
      { label: "Line Speed Rating",  value: "Up to 350+ m/min on modern high-speed corrugators" },
      { label: "Application",        value: "B/C/E/F flute corrugated board — slit and score on BHS, Marquip, FOSBER corrugators" },
    ...
    dimensionLabels: {
      ...
      col2: "Inner Diameter (ID)",
      col3: "Body Thickness",
      caption: "* Dimensions above are standard OEM specifications for Thin Slitter Blades. Drive pin holes are machined to brand tolerances. Slotter, Scorer, and Z Cut-off knives are manufactured to exact customer or OEM blueprints.",
    },

    standardDimensions: [
      { spec: "BHS",               od: "240 mm", id: "115 mm", thickness: "1.0 / 1.2 mm" },
      { spec: "BHS",               od: "260 mm", id: "140 mm", thickness: "1.2 mm" },
      { spec: "FOSBER",            od: "230 mm", id: "135 mm", thickness: "1.15 / 1.2 mm" },
      { spec: "FOSBER",            od: "260 mm", id: "112 mm", thickness: "1.2 mm" },
      { spec: "Marquip",           od: "230 mm", id: "110 mm", thickness: "1.2 / 1.5 mm" },
    ...
    faqs: {
      technical: [
        {
          question: "Why are my thin slitter blades crushing the flutes on E and F flute boards?",
          answer:
        ...
        {
          question: "How do your blades interact with automatic slitter-scorer sharpening systems?",
          answer:
        ...
        {
          question: "What is the advantage of a Split Top and Bottom Circular Knife?",
          answer:
      ...
      company: [
        {
          question: "Can Sureay supply the entire knife package for a new corrugator and FFG installation?",
          answer:
        ...
        {
          question: "Do you maintain dimensions for Bobst / Martin Flexo Folder Gluers?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    specs: [
      ...
      { label: "Standard Geometry", value: "3-Claw Rotary (Custom hook counts available)" },
    ...
    dimensionLabels: {
      ...
      col4: "Claw Count",
      caption: "* Dimensions shown are industry standard examples. We manufacture strictly to your exact machine specifications and required TDF chip size.",
    },
    ...
    standardDimensions: [
      { spec: "Barclay Standard", od: "Φ 450 mm (17.7\")", thickness: "50.8 mm (2.0\")", bore: "Hex / Splined",  hooks: "3 Claws"         },
      { spec: "CM Primary",       od: "Φ 500 mm (19.6\")", thickness: "50.8 mm (2.0\")", bore: "Heavy Splined",  hooks: "3 Claws"         },
      { spec: "SSI / Untha",      od: "Φ 400–600 mm",      thickness: "25–75 mm",        bore: "Hex / Octagon",  hooks: "1 / 3 / 5 Claws" },
      { spec: "OTR Shredder",     od: "Φ 800+ mm",         thickness: "100+ mm",         bore: "Heavy Keyed",    hooks: "1 / 3 Claws"      },
    ],
    ...
    faqs: {
      technical: [
        {
          question: "Why should I upgrade to Cru-Wear (PGK) from standard D2 tool steel?",
          answer:
        ...
        {
          question: "How does blade tolerance affect my shredder's energy consumption?",
          answer:
      ...
      company: [
        {
          question: "Can you supply spacers and cleaning fingers (scraper plates) to match the blades?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "M2 HSS Circular Slitter Knives for Spunbond, Meltblown & SMS Nonwoven Fabrics",
    category: "slitter_knives",
    sector: "converting",
    ...
    isFeatured: false,
    compatibleMachines: ["Parkinson Spencer Rees", "Atlas Converting", "Euromac", "ACCO Brands", "Erhardt+Leimer"],

    specs: [
      { label: "Material",       value: "M2 HSS (standard) / D2 (heavy nonwoven) / 52100 (hydroentangled)" },
      { label: "Hardness",       value: "HRC 62–64 (M2) | HRC 60–62 (D2)" },
      { label: "Rake Angle",     value: "15°–20° positive rake (nonwoven-optimised geometry)" },
      { label: "Surface Finish", value: "Ra ≤ 0.4μm — reduces fibre adhesion and slub formation" },
      { label: "Options",        value: "ESD conductive coating (meltblown / filtration media)" },
    ...
    dimensionLabels: {
      ...
      col2: "Inner Diameter (ID)",
      col3: "Thickness",
      caption: "* Standard dimensions for common nonwoven slitting machine models. Custom OD, ID, and edge geometry available. ESD coating (+10–15% on unit price) available for all sizes.",
    },
    ...
    relatedBladeIds: ["rotary-slitter-knives", "lithium-battery-slitting-knives"],
    offers: {
      lowPrice:  20,
      highPrice: 150,
    },
    faqs: {
      technical: [
        {
          question: "What rake angle should I specify for spunbond polypropylene at 200 m/min?",
          answer:
        ...
        {
          question: "My meltblown slitting produces visible fibre transfer on the blade face. What is the cause?",
          answer:
      ...
      company: [
        {
          question: "Can Sureay supply nonwoven slitter knives with a certificate of conformance for our medical device supplier audit?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    specs: [
      { label: "Grade Options",  value: "M2 HSS (DMo5) · M35 Cobalt (Co5) · TCT Carbide" },
      { label: "Hardness",       value: "HRC 63–65 (M2) | HRC 64–66 (M35) | Carbide Tipped" },
      { label: "Surface Finish", value: "Steam Treated (Black) / TiN / TiAlN PVD Coatings" },
      { label: "Tooth Form",     value: "BW, HZ (Standard) | Fine / Medium / Coarse Pitch" },
    ...
    standardDimensions: [
      { spec: "M2 HSS (Steam Treated)",    od: "250",  id: "32 / 40", length: "2.0", teeth: "120 z / 160 z" },
      { spec: "M2 HSS (Steam Treated)",    od: "275",  id: "32 / 40", length: "2.5", teeth: "140 z / 180 z" },
      { spec: "M35 Cobalt (TiN Coated)",   od: "315",  id: "32 / 40", length: "2.5", teeth: "160 z / 200 z" },
      { spec: "M35 Cobalt (TiAlN Coated)", od: "350",  id: "40 / 50", length: "2.5", teeth: "160 z / 220 z" },
      { spec: "M2 / M35 HSS",             od: "400",  id: "40 / 50", length: "3.0", teeth: "180 z / 240 z" },
      { spec: "TCT (Aluminum Profile)",    od: "450",  id: "30 / 32", length: "3.5", teeth: "120 z" },
    ],
    ...
    faqs: {
      technical: [
        ...
        {
          question: "How many teeth (TPI / Pitch) do I need for my steel pipes?",
          answer:
      ...
      company: [
        ...
        {
          question: "What is the lead time for M35 Cobalt or TiAlN coated blades?",
          answer:
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fullName: "Heavy-Duty Scrap Chopper Blades for Metal Slitting & Coil Processing Lines",
    category: "metal_processing",
    sector: "metal",
    categoryDisplay: "Metal Processing Blades",
    ...
    isFeatured: false,
    compatibleMachines: ["Butech Bliss", "Red Bud Industries", "Braner USA", "Herr-Voss Stamco", "Kohler Maschinenbau", "Fagor Arrasate"],

    specs: [
      { label: "Material",         value: "S7 Shock-Resisting Tool Steel | H13 Hot-Work Steel | Carbide-Inlaid S7" },
      { label: "Hardness",         value: "HRC 54–58 (optimized for maximum impact toughness)" },
      { label: "Edge Configuration", value: "Square/Rectangular Profile (4-edge usable)" },
      { label: "Impact Resistance", value: "2× toughness vs. D2 — prevents catastrophic fracture" },
      { label: "Application",      value: "Steel, aluminum, copper edge-trim scrap from slitting & coil processing lines" },
    ...
    dimensionLabels: {
      ...
      col2: "Width (mm)",
      col3: "Thickness (mm)",
      caption: "* Standard dimensions for common scrap chopper models. Custom sizes available. All blades are 4-edge reversible. Carbide-inlaid option available for all dimensions (+30–40% unit price premium).",
    },
    ...
    faqs: {
      technical: [
        {
          question: "Should I use S7 or H13 for chopping stainless steel edge trim?",
          answer:
        ...
        {
          question: "How do I know when to index the blade to the next cutting edge?",
          answer:
      ...
      company: [
        {
          question: "Does Sureay stock scrap chopper blades, or are they made to order?",
          answer:
        ...
        {
          question: "Can Sureay supply scrap chopper blades that match our existing blade dimensions?",
          answer:
